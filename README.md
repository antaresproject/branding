...
Antares Branding Module changelog can be found in release notes [antaresproject.io/docs/site/getting_started/changelog#branding](http://antaresproject.io/docs/site/getting_started/changelog/index.html#branding).
